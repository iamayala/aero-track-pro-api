...
exports.post = (req, res) => {
	...
	db.query(
     ...
     (activity_type, activity_description, aircraft_id, technician_id, priority, start_datetime, end_datetime, parts_replaced, issues_resolved, status) 
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
		[
			activity_type,
			activity_description,
...
exports.delete = (req, res) => {
	...
	db.query("DELETE FROM MaintenanceActivities WHERE id = ?", [activityId], (err) => {
		if (err) {
