...
exports.post = (req, res) => {
  ...
  db.query(
    ...
    [flight_number, departure_airport, departure_datetime, arrival_airport, arrival_datetime, aircraft_id, pilot_id, co_pilot_id, JSON.stringify(crew_members), JSON.stringify(passengers), status],
    (err, results) => {
      if (err) {
...
exports.get = (req, res) => {
  db.query('SELECT Flights.*, Aircrafts.* FROM Flights JOIN Aircrafts ON Flights.aircraft_id = Aircrafts.id', (err, results) => {
    if (err) {
...
exports.getOne = (req, res) => {
  ...
  db.query('SELECT Flights.*, Aircrafts.* FROM Flights JOIN Aircrafts ON Flights.aircraft_id = Aircrafts.id WHERE Flights.id = ?', [id], (err, results) => {
    if (err) {
...
exports.put = (req, res) => {
  ...
  db.query(
    ...
    [flight_number, departure_airport, departure_datetime, arrival_airport, arrival_datetime, aircraft_id, pilot_id, co_pilot_id, JSON.stringify(crew_members), JSON.stringify(passengers), status, id],
    (err, results) => {
      if (err) {
